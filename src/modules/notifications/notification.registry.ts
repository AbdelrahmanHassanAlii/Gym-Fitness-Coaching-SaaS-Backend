...
export const notificationRegistry: NotificationRegistryEntry[] = [
  ...
  },
  {
    ...
    notificationType: 'RETENTION_WARNING_DUE',
    category: 'SUBSCRIPTION',
    channels: ['IN_APP', 'EMAIL'],
    mandatory: true,
    stalePolicy: 'FACT',
  },
  {
    ...
    notificationType: 'WORKSPACE_DELETION_REQUESTED',
    category: 'SUBSCRIPTION',
    channels: ['IN_APP', 'EMAIL'],
    mandatory: true,
    stalePolicy: 'FACT',
  },
  {
    ...
    notificationType: 'WORKSPACE_DELETION_POSTPONED',
    category: 'SUBSCRIPTION',
    channels: ['IN_APP', 'EMAIL'],
    mandatory: true,
    stalePolicy: 'FACT',
  },
  {
    ...
    notificationType: 'WORKSPACE_DELETION_CANCELLED',
    category: 'SUBSCRIPTION',
    channels: ['IN_APP', 'EMAIL'],
    mandatory: true,
    stalePolicy: 'FACT',
  },
  {
    ...
    notificationType: 'WORKSPACE_DELETION_APPROVED',
    category: 'SECURITY',
    channels: ['IN_APP', 'EMAIL'],
    mandatory: true,
    stalePolicy: 'FACT',
  },
  {
    ...
    notificationType: 'WORKSPACE_EXPORT_READY',
    category: 'SECURITY',
    channels: ['IN_APP', 'EMAIL'],
    mandatory: true,
    stalePolicy: 'FACT',
  },
  {
    ...
    notificationType: 'WORKSPACE_EXPORT_FAILED',
    category: 'SECURITY',
    channels: ['IN_APP'],
    mandatory: true,
    stalePolicy: 'FACT',
  },
  {
    ...
    notificationType: 'WORKSPACE_EXPORT_EXPIRED',
    category: 'SECURITY',
    channels: ['IN_APP'],
    mandatory: true,
    stalePolicy: 'FACT',
